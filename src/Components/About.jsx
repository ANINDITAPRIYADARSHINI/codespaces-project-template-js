 ...
 */
const description =
  "I'm a self-taught FrontEnd Developer with a master's degree in computer application(MCA). I enjoy creating unique and simplistic user interfaces in creative ways to solve user problems.";
...
const About = () => {
  return (
    <section className="padding" id="about">
      ...
      >
        <h2 style={{ color: "#96ABA3" }}>About Myself</h2>
